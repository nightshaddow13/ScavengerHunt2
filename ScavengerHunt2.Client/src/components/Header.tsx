            ...
            <div className="absolute z-10 top-2 left-2 sm:static flex-shrink flex-grow-0">
                <div className="cursor-pointer">
                    <Link to="/" className="navbar-brand flex items-center">
                        <Logo className="w-8 h-8 sm:ml-2 sm:w-12 sm:h-12" title="ScavengerHunt2 logo"/>
                        <span className="hidden ml-2 sm:block text-2xl font-semibold">Scavenger Hunt2</span>
                    </Link>
                </div>
            </div>
