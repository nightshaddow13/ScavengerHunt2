...
[Configure.Auth.cs](https://github.com/NetCoreTemplates/blazor/blob/main/ScavengerHunt2/Configure.Auth.cs):
...
[CustomUserSession.cs](https://github.com/NetCoreTemplates/blazor/blob/main/ScavengerHunt2.ServiceInterface/Data/CustomUserSession.cs), e.g:
...
for a new Blazor Project from its [Program.cs](https://github.com/NetCoreTemplates/blazor/blob/main/ScavengerHunt2/Program.cs):
...
services.AddDbContext<ApplicationDbContext>(options =>
    options.UseSqlite(connectionString, b => b.MigrationsAssembly(nameof(ScavengerHunt2))));
...
configuration in its [Program.cs](https://github.com/NetCoreTemplates/mvc/blob/main/ScavengerHunt2/Program.cs) which will 
also require adding the NuGet dependencies of the OAuth providers you want to support which you can get from its
[ScavengerHunt2.csproj](https://github.com/NetCoreTemplates/mvc/blob/main/ScavengerHunt2/ScavengerHunt2.csproj)
...
UI Pages are in the 
[Components/Identity](https://github.com/NetCoreTemplates/blazor/tree/main/ScavengerHunt2/Components/Identity) and 
[Pages/Account](https://github.com/NetCoreTemplates/blazor/tree/main/ScavengerHunt2/Components/Pages/Account) folders.

For MVC, most of the Identity UI are in the 
[Account](https://github.com/NetCoreTemplates/mvc/blob/main/ScavengerHunt2/Controllers/AccountController.cs)
and [Manage](https://github.com/NetCoreTemplates/mvc/blob/main/ScavengerHunt2/Controllers/ManageController.cs) controllers
as well as their
[Views/Account](https://github.com/NetCoreTemplates/mvc/tree/main/ScavengerHunt2/Views/Account) and
[Views/Manage](https://github.com/NetCoreTemplates/mvc/tree/main/ScavengerHunt2/Views/Manage) folders.
...
[Configure.Mq.cs](https://github.com/NetCoreTemplates/blazor/blob/main/ScavengerHunt2/Configure.Mq.cs)
which uses it to invoke the `SendEmail` API in 
[EmailServices](https://github.com/NetCoreTemplates/blazor/blob/main/ScavengerHunt2.ServiceInterface/EmailServices.cs) in a 
