...
[GettingStarted.mjs](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/wwwroot/mjs/components/GettingStarted.mjs) Vue Component to create new Razor SSG App's below with:
...
| [Configure.Ssg.cs](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Configure.Ssg.cs) | Initializes and registers the feature with ASP .NET's IOC |
...
### [/_pages](https://github.com/NetCoreTemplates/razor-ssg/tree/main/ScavengerHunt2/_pages)
 - privacy.md
 - speaking.md
 - uses.md
...
The code that loads the Pages feature markdown content is in [Markdown.Pages.cs](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Markdown.Pages.cs):
...
The pages are then rendered in [Page.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Page.cshtml) Razor Page
that's available from `/{slug}`

```csharp
@page "/{slug}"
@model ScavengerHunt2.Page
@inject MarkdownPages Markdown

@implements IRenderStatic<ScavengerHunt2.Page>
@functions {
...
[speaking.md](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/_pages/speaking.md) utilizes in its **layout** frontmatter:
...
To render the page using [_LayoutContent.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Shared/_LayoutContent.cshtml)
...
### [/_whatsnew](https://github.com/NetCoreTemplates/razor-ssg/tree/main/ScavengerHunt2/_whatsnew)
...
What's New follows the same structure as Pages feature which is loaded in:
 ...
 - [Markdown.WhatsNew.cs](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Markdown.WhatsNew.cs)

and rendered in:
- [WhatsNew.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/WhatsNew.cshtml)
...
### [/_posts](https://github.com/NetCoreTemplates/razor-ssg/tree/main/ScavengerHunt2/_posts)
...
As the Blog has more features it requires a larger [Markdown.Blog.cs](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Markdown.Blog.cs)
to load its Markdown posts that is rendered in several different Razor Pages for each of its Views:

| Page | Description | Example |
| - | - | - |
| [Blog.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Blog.cshtml) | Main Blog layout | [/blog](https://razor-ssg.web-templates.io/blog) | 
| [Posts/Index.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Index.cshtml) | Navigable Archive grid of Posts | [/posts](https://razor-ssg.web-templates.io/posts) | 
| [Posts/Post.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Post.cshtml) | Individual Blog Post (like this!) | [/posts/razor-ssg](https://razor-ssg.web-templates.io/posts/razor-ssg) |
| [Author.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Author.cshtml) | Display Posts by Author | [/posts/author/lucy-bates](https://razor-ssg.web-templates.io/posts/author/lucy-bates) | 
| [Tagged.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Tagged.cshtml) | Display Posts by Tag | [/posts/tagged/markdown](https://razor-ssg.web-templates.io/posts/tagged/markdown) |
| [Year.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Year.cshtml) | Display Posts by Year | [/posts/year/2023](https://razor-ssg.web-templates.io/posts/year/2023) |
...
All markdown features are initialized in the same way in [Configure.Ssg.cs](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Configure.Ssg.cs)
...
[postinstall.js](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/postinstall.js) by running:
...
The included [MarkdownTagHelper.cs](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/MarkdownTagHelper.cs) can be used
in hybrid Razor Pages like [About.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/About.cshtml) 
...
[About.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/About.cshtml):
...
[Posts/Index.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Index.cshtml):
...
as done in [Posts/Post.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Post.cshtml) and
[Page.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Page.cshtml):
...
[/_pages](https://github.com/NetCoreTemplates/razor-ssg/tree/main/ScavengerHunt2/_pages) that ends up rendering the following pages in `/dist`:
...
[Posts/Author.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Author.cshtml)
...
[Posts/Tagged.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Tagged.cshtml)
...
[Posts/Year.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Pages/Posts/Year.cshtml)
...
[Configure.Ssg.cs](https://github.com/NetCoreTemplates/razor-ssg/blob/main/ScavengerHunt2/Configure.Ssg.cs):
...
It only needed one new Markdown feature to display our growing video library:
 ...
 - [/_videos](https://github.com/ServiceStack/servicestack.net/tree/main/ScavengerHunt2/_videos) - Directory of Markdown Video collections 
 - [Markdown.Videos.cs](https://github.com/ServiceStack/servicestack.net/blob/main/ScavengerHunt2/Markdown.Videos.cs) - Loading Video feature markdown content
 - [Shared/VideoGroup.cshtml](https://github.com/ServiceStack/servicestack.net/blob/main/ScavengerHunt2/Pages/Shared/VideoGroup.cshtml) - Razor Page for displaying Video Collection
