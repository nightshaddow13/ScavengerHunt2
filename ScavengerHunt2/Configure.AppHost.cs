using ScavengerHunt2.ServiceInterface;
using ServiceStack.NativeTypes.TypeScript;

[assembly: HostingStartup(typeof(ScavengerHunt2.AppHost))]

namespace ScavengerHunt2;

public class AppHost() : AppHostBase("ScavengerHunt2"), IHostingStartup
{
